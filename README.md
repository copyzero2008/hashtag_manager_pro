...
**Hashtag Manager Pro** is a browser extension designed to make managing and using Twitter (X) hashtags simpler. It allows you to organize tags into categories, create drag-and-drop presets, and use a unique "Priority Ladder" to ensure your tags always end up just in the order you want them.
...
1. **Download:** Go to the \[suspicious link removed\] page and download the Source code (zip) or the release .zip file.  
...
6. **Pin it:** Click the puzzle piece icon in your browser toolbar and pin **Hashtag Manager Pro**.

## **🚀 How to Use**

### **Basic Usage**

1. **Open:** Go to X.com (Twitter) and click the extension icon.  
2. **Create Category:** Click the \+ icon next to the tabs list to create a new category (Tab).  
3. **Add Tags:** Click the **\+ Add** chip at the end of the tag list. You can add multiple tags at once by separating them with spaces.  
4. **Copy:** Simply click any tag chip to copy it to your clipboard.
...
1. **Add:** Drag tags or full categories into the ladder.  
2. **Sort:** Drag items up or down to change their priority.  
3. **Logic:** If you add a hashtag AND its category to the ladder, whichever is higher takes precedence.  
4. **Toggle:** You can turn the sorting logic on/off with the toggle switch in the drawer.
